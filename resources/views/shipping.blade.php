    ...
    <main class="main">
        @if ($temporaryAddress !== null)
            <div class="features-section">
                <div class="container">
                    <h2 class="subtitle">Select Address</h2>
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="feature-box">
                                ...
                                <div class="feature-box-content">
                                    <h3>Address: {{ $temporaryAddress->address }}</h3>
                                ...
                                <div class="checkout-methods">
                                    <a href="/cart" class="btn btn-block btn-sm btn-primary">Continue with this
                                        address</a>
                                    <a
                                        href="/shipping_change/{{ $temporaryAddress->id }}"class="btn btn-block btn-sm btn-danger">Use
                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="checkout-steps-action">
                            <button class="btn btn-sm btn-primary" title="Submit Address" value="delete "
